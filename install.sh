...
echo "║                                                              ║"
echo "║    vim ~/.config/zsh-aisuggestions/config.yaml               ║"
echo "║                                                              ║"
echo "║  Set api_base_url, model, and your API key:                  ║"
echo "║    Option 1: api_key: sk-...    (directly in config)         ║"
echo "║    Option 2: api_key_env: ...   (env var, recommended)       ║"
echo "║                                                              ║"
